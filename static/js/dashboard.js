...
function updateStatistics(data) {
    if (data.statistics) {
        ...
        document.getElementById('pumps-24h').textContent =
            data.statistics.pumps_24h || 0;

        // Calculate accuracy
        const total = data.statistics.signals_24h || 0;
        const confirmed = data.statistics.pumps_24h || 0;
